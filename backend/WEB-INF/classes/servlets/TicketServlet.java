...
//     final String instructionPrompt = "You are a customer service assistant for a delivery service. Analyze the images of packages and provide the correct decision based on the following criteria: " +
//         "1. If the package appears damaged, suggest a refund. " +
//         "2. If the package looks wet, suggest a replacement. " +
//         "3. If the package looks normal and undamaged, state that everything is fine and no action is required. " +
//         "4. For any other issues or unclear images, escalate to a human agent. " +
//         "Respond only with the decision and avoid additional comments.";
...
//         "{\"role\": \"user\", \"content\": \"%s\"}," +
//         "{\"role\": \"user\", \"content\": \"%s\"}]}",
//         instructionPrompt, description, imageBase64 // Use your image data here
//     );
...
//     connection.setRequestProperty("Authorization", "Bearer " + "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");
...
//             }
//             return parseOpenAiResponse(response.toString()); // Assume you have a method to parse the response
//         }
//     } else {
//         throw new IOException("Error: " + connection.getResponseMessage());
//     }
// }
...
//     // Find the starting point of the "content" field
//     String contentKey = "\"content\":\"";
//     int contentIndex = responseBody.indexOf(contentKey);

//     // If the "content" field is found, extract its value
//     if (contentIndex != -1) {
//         contentIndex += contentKey.length();
//         int endIndex = responseBody.indexOf("\"", contentIndex);
        
//         if (endIndex != -1) {
//             // Extract the content and return it trimmed
//             return responseBody.substring(contentIndex, endIndex).trim();
//         }
//     }
    
//     // Return an empty string if "content" is not found
//     return "";
// }
